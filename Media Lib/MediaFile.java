...
public class MediaFile  
{
    ...
    private static final String DATA_FILE2 = "1000 Songs To Hear Before You Die - 1st Period 2017-2018.txt";
    //private static final String DATA_FILE = "/Volumes/No Name/AP Computer Science/Media Lib/mymedia.txt";
    private static final String DATA_FILE1 = "mymedia1.txt";
    ...
    public static void writeString(String s) {
        if (out == null) {
            try {
                out = new BufferedWriter(new FileWriter(DATA_FILE2));
            }
            catch (Exception e) {
    ...
    public static void writeString1(String s) {
        if (out == null) {
            try {
                out = new BufferedWriter(new FileWriter(DATA_FILE1));
            }
            catch (Exception e) {
                System.err.println("Cannot create file for output!");
                e.printStackTrace();
